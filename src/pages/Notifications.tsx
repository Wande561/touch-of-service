  ...
  const notifications = [
    {
      ...
      message: 'Sarah Johnson requested your house cleaning service for tomorrow at 9 AM.',
    ...
    },
    {
      ...
      type: 'message',
      title: 'New Message',
      message: 'Mike Rodriguez sent you a message about the plumbing repair.',
    ...
    },
    {
      ...
      message: 'You received $75 for the electrical repair service.',
    ...
    },
    {
      ...
      type: 'review',
      title: 'New Review',
      message: 'Alex Chen left you a 5-star review for personal training session.',
      timestamp: '1 day ago',
      unread: false,
      avatar: '/placeholder.svg',
      action: 'view',
    },
    {
      ...
      message: 'You have a landscaping appointment tomorrow at 2 PM.',
      timestamp: '1 day ago',
      unread: false,
      avatar: null,
      action: 'view',
